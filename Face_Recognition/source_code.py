...
face_classifier = cv2.CascadeClassifier("Z:\\Face_Recognition\\haarcascade_frontalface_default.xml")

smile_classifier = cv2.CascadeClassifier("Z:\\Face_Recognition\\haarcascade_smile.xml")
